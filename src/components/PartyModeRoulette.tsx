...
export const PartyModeRoulette: React.FC<Props> = ({ language }) => {
  ...
  return (
    <section id="party-roulette-section" className="scroll-mt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="relative rounded-3xl bg-stone-900 border border-amber-500/30 p-6 sm:p-8 md:p-10 shadow-2xl shadow-black/80 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-amber-500/15 border border-amber-500/40 flex items-center justify-center text-amber-400 text-2xl shadow-inner shrink-0">
              🎉
            </div>
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-black text-stone-100 font-['Unbounded'] mt-0.5">
                {isUa ? '«У мене паті» • Пʼяна Рулетка' : '«Party Mode» • Drunk Roulette'}
              </h2>
              <p className="text-xs sm:text-sm text-stone-400 mt-1 max-w-xl">
                {isUa
                  ? 'Введи свій алкоголь, закуски та безалкогольні напої — рулетка згенерує унікальні кумедні виклики та завдання під вашу компанію!'
                  : 'Enter your bottles, snacks, mixers, and headcount — our mixology AI generates a customized drinking roulette for your crew!'}
              </p>
            </div>
          </div>
          ...
          {isPlaying && (
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-stone-950 hover:bg-stone-800 text-stone-300 border border-stone-800 font-bold font-['Unbounded'] text-xs flex items-center gap-2 transition-all cursor-pointer"
            >
        ...
        {!isPlaying ? (
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="p-5 rounded-2xl bg-stone-950/80 border border-stone-800">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder={isUa ? 'Додати інший алкоголь (напр. Коньяк, Самбука, Сидр)...' : 'Add custom alcohol...'}
                  className="flex-1 px-3.5 py-2.5 rounded-xl bg-stone-900 border border-stone-800 text-stone-200 text-xs focus:outline-none focus:border-amber-500 transition-colors"
                />
                <button
                  type="button"
                  onClick={handleAddAlcohol}
                  disabled={!customAlc.trim()}
                  className="px-4 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 disabled:opacity-50 disabled:hover:bg-amber-500 text-stone-950 text-xs font-bold font-['Unbounded'] cursor-pointer flex items-center gap-1.5 transition-all shadow-md active:scale-95 shrink-0"
                >
            ...
            <div className="p-5 rounded-2xl bg-stone-950/80 border border-stone-800">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder={isUa ? 'Додати закуску (напр. Сало, Піца, Горішки)...' : 'Add custom snack...'}
                  className="flex-1 px-3.5 py-2.5 rounded-xl bg-stone-900 border border-stone-800 text-stone-200 text-xs focus:outline-none focus:border-emerald-500 transition-colors"
                />
                <button
                  type="button"
                  onClick={handleAddSnack}
                  disabled={!customSnack.trim()}
                  className="px-4 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 disabled:hover:bg-emerald-500 text-stone-950 text-xs font-bold font-['Unbounded'] cursor-pointer flex items-center gap-1.5 transition-all shadow-md active:scale-95 shrink-0"
                >
                  <Plus className="w-4 h-4" />
                  <span>{isUa ? 'Додати' : 'Add'}</span>
                </button>
            ...
            <div className="p-5 rounded-2xl bg-stone-950/80 border border-stone-800">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder={isUa ? 'Додати напій (напр. Молоко, Енергетик, Березовий сік)...' : 'Add mixer...'}
                  className="flex-1 px-3.5 py-2.5 rounded-xl bg-stone-900 border border-stone-800 text-stone-200 text-xs focus:outline-none focus:border-sky-500 transition-colors"
                />
                <button
                  type="button"
                  onClick={handleAddSoftDrink}
                  disabled={!customSoft.trim()}
                  className="px-4 py-2.5 rounded-xl bg-sky-500 hover:bg-sky-400 disabled:opacity-50 disabled:hover:bg-sky-500 text-stone-950 text-xs font-bold font-['Unbounded'] cursor-pointer flex items-center gap-1.5 transition-all shadow-md active:scale-95 shrink-0"
                >
                  <Plus className="w-4 h-4" />
                  <span>{isUa ? 'Додати' : 'Add'}</span>
                </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-5 rounded-2xl bg-stone-950/80 border border-stone-800">
                <label className="block text-xs font-bold text-stone-200 uppercase tracking-wider font-['Unbounded'] mb-2">
                  <Users className="w-4 h-4 inline-block mr-1 text-amber-400" />
              ...
              {/* Guest Names Input */}
              <div className="p-5 rounded-2xl bg-stone-950/80 border border-stone-800 md:col-span-2">
                <label className="block text-xs font-bold text-stone-200 uppercase tracking-wider font-['Unbounded'] mb-2">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-stone-900 border border-stone-800 text-stone-200 text-xs focus:outline-none focus:border-amber-500"
                />
            ...
            <div className="p-5 rounded-2xl bg-stone-950/80 border border-stone-800">
              <label className="block text-xs font-bold text-stone-200 uppercase tracking-wider font-['Unbounded'] mb-3">
                <Flame className="w-4 h-4 inline-block mr-1 text-rose-400" />
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full py-4 px-6 rounded-2xl bg-gradient-to-r from-amber-500 via-orange-500 to-amber-500 hover:from-amber-400 hover:to-orange-400 text-stone-950 font-black font-['Unbounded'] text-sm sm:text-base flex items-center justify-center gap-3 transition-all shadow-xl shadow-amber-500/25 cursor-pointer"
            >
          ...
          <div className="relative z-10 space-y-6">
            {/* Active Turn Header */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-4 rounded-2xl bg-stone-950/90 border border-stone-800">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-xl bg-amber-500/15 border border-amber-500/40 flex items-center justify-center text-amber-400 text-lg font-bold font-mono">
                ...
                <div>
                  ...
                  <h3 className="text-lg sm:text-xl font-black text-white font-['Unbounded']">
                    🎯 {currentGuest}
                  </h3>
                </div>
              </div>
            ...
            <div
              className={`relative rounded-3xl p-6 sm:p-10 border transition-all duration-300 overflow-hidden ${
                isSpinning
            ...
            >
              {currentChallenge && (
                <div className="text-center max-w-xl mx-auto">
                  <div className="inline-block text-5xl sm:text-6xl mb-4 animate-bounce">
                  ...
                  <p className="text-lg sm:text-2xl font-bold text-stone-100 leading-relaxed font-['Plus_Jakarta_Sans'] mb-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <button
                      ...
                      disabled={isSpinning}
                      className="py-3.5 px-6 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-stone-950 font-black font-['Unbounded'] text-xs sm:text-sm flex items-center justify-center gap-2 transition-all shadow-lg shadow-emerald-500/20 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      disabled={isSpinning}
                      className="py-3.5 px-5 rounded-2xl bg-stone-950 hover:bg-rose-950/40 text-rose-300 border border-stone-800 hover:border-rose-800 font-bold font-['Unbounded'] text-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      disabled={isSpinning}
                      className="py-3.5 px-6 rounded-2xl bg-amber-500 hover:bg-amber-400 text-stone-950 font-black font-['Unbounded'] text-xs sm:text-sm flex items-center justify-center gap-2 transition-all shadow-lg shadow-amber-500/20 cursor-pointer"
                    >
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 p-4 rounded-2xl bg-stone-950/60 border border-stone-800 text-xs text-stone-400">
              <div className="flex items-center gap-2">
                <span className="font-bold text-amber-400">🍾 Алкоголь:</span>
                <span className="text-stone-300">{alcohols.slice(0, 4).join(', ')}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="font-bold text-emerald-400">🥒 Закуски:</span>
                <span className="text-stone-300">{snacks.slice(0, 3).join(', ')}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="font-bold text-sky-400">🍓 Безалкогольне:</span>
